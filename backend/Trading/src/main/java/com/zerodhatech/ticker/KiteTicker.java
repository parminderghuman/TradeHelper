...
public class KiteTicker {
    ...
    public KiteTicker(String accessToken, String apiKey,String userId) {
    	 if (wsuri == null) {
             createUrl(accessToken,apiKey, userId);
         }
   ...
   public void setOnErrorListener(OnError listener){
    ...
    private void createUrl(String accessToken, String apiKey, String userId) {
        wsuri = new Routes().getWsWeburl().replace(":access_token", accessToken).replace(":user_id", userId);
