...
public class MinuteCandleData {
	...
	public MinuteCandleData() {
		// TODO Auto-generated constructor stub
	}
	public MinuteCandleData(Instrument instrument, List<String> candle) throws Exception {
		...
		this.candleDataMinuteKey = new CandleDataMinuteKey(instrument.instrumentToken,completeDate);
	 ...
	 @EmbeddedId
	    private CandleDataMinuteKey candleDataMinuteKey;
	...
	public CandleDataMinuteKey getCandleDataMinuteKey() {
		return candleDataMinuteKey;
	}
	public void setCandleDataMinuteKey(CandleDataMinuteKey candleDataMinuteKey) {
		this.candleDataMinuteKey = candleDataMinuteKey;
	}
	
	public Date getCompleteDate() {
		return this.candleDataMinuteKey.getCompleteDate();
	}
	public long getInstrumentToken() {
		// TODO Auto-generated method stub
		return this.candleDataMinuteKey.getInstrumentToken();
